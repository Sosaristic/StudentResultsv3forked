...
export default function PerformanceCard() {
  ...
  return (
    <div className="flex flex-col px-4 gap-2 md:flex-row md:items-center font-inter justify-between">
      <div className="flex justify-around border min-h-[4rem] max-h-[8rem] bg-dark-green p-4 text-grey-white shadow-dashboard-card rounded-md">
        <div>
      ...
      <div className="flex border min-h-[4rem] max-h-[8rem] bg-dark-green p-4 text-grey-white shadow-dashboard-card rounded-md">
        <div>
